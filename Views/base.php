...
<body>
   ...
   <?php if (!strpos($content, 'Login')): ?>
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
         <div class="container">
            <a class="navbar-brand pulse" href="/"><img src="<?= fld_url('Public/Images/logo.png') ?>" height="50px"><?=getenv("SITE_NOME");?></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               ...
               <?php if (isset($_SESSION['role'])): ?>
                  <div class="d-flex animate-bounce-light">
   ...
   ?>
   <?php if (!strpos($content, 'Login')): ?>
      <footer class="mt-auto gradient-bg pt-5 text-light">
         <div class="container">
            <div class="row">
